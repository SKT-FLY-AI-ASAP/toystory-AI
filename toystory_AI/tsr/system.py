...
class TSR(BaseModule):
    ...
    def generate_image_with_dalle(self, image_content):
        lines = [
            ...
            "5. Ensure that only one object is present in the image.",
        ]
        # lines = [
        ...
        #     "4. Apply a 3D style to the object, making it look more like a character.",
        #     "5. Position the object at a 15-degree angle to show a side view, emphasizing its character-like qualities."
        # ]
        prompt = "\n".join(lines)
    ...
    def generate_image_from_text(self, text: str) -> Image.Image:
        lines = [
            ...
            "Use a 3D rendering style for the object, giving it a character-like appearance.",
            "Position the object at a 15-degree angle to show a slight side view, enhancing its character-like qualities."
        ]
        prompt = "\n".join(lines)
        response = openai.images.generate(
            model="dall-e-3",
